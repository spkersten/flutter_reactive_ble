...
class CharacteristicAddress extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CharacteristicAddress', createEmptyInstance: create)
    ...
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serviceIndex', protoName: 'serviceIndex')
    ..aOM<Uuid>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'characteristicUuid', protoName: 'characteristicUuid', subBuilder: Uuid.create)
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'characteristicIndex', protoName: 'characteristicIndex')
    ..hasRequiredFields = false
  ;
  ...
  factory CharacteristicAddress({
    $core.String? deviceId,
    Uuid? serviceUuid,
    $core.String? serviceIndex,
    Uuid? characteristicUuid,
    $core.String? characteristicIndex,
  }) {
    final _result = create();
    if (deviceId != null) {
      _result.deviceId = deviceId;
    ...
    if (serviceIndex != null) {
      _result.serviceIndex = serviceIndex;
    }
    if (characteristicUuid != null) {
      _result.characteristicUuid = characteristicUuid;
    }
    if (characteristicIndex != null) {
      _result.characteristicIndex = characteristicIndex;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(3)
  $core.String get serviceIndex => $_getSZ(2);
  @$pb.TagNumber(3)
  set serviceIndex($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasServiceIndex() => $_has(2);
  @$pb.TagNumber(3)
  void clearServiceIndex() => clearField(3);

  @$pb.TagNumber(4)
  Uuid get characteristicUuid => $_getN(3);
  @$pb.TagNumber(4)
  set characteristicUuid(Uuid v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasCharacteristicUuid() => $_has(3);
  @$pb.TagNumber(4)
  void clearCharacteristicUuid() => clearField(4);
  @$pb.TagNumber(4)
  Uuid ensureCharacteristicUuid() => $_ensure(3);

  @$pb.TagNumber(5)
  $core.String get characteristicIndex => $_getSZ(4);
  @$pb.TagNumber(5)
  set characteristicIndex($core.String v) { $_setString(4, v); }
  @$pb.TagNumber(5)
  $core.bool hasCharacteristicIndex() => $_has(4);
  @$pb.TagNumber(5)
  void clearCharacteristicIndex() => clearField(5);
}
...
class GetDiscoveredServicesRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetDiscoveredServicesRequest', createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deviceId', protoName: 'deviceId')
    ..hasRequiredFields = false
  ;

  GetDiscoveredServicesRequest._() : super();
  factory GetDiscoveredServicesRequest({
    $core.String? deviceId,
  }) {
    final _result = create();
    if (deviceId != null) {
  ...
  factory GetDiscoveredServicesRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GetDiscoveredServicesRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  GetDiscoveredServicesRequest clone() => GetDiscoveredServicesRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetDiscoveredServicesRequest copyWith(void Function(GetDiscoveredServicesRequest) updates) => super.copyWith((message) => updates(message as GetDiscoveredServicesRequest)) as GetDiscoveredServicesRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static GetDiscoveredServicesRequest create() => GetDiscoveredServicesRequest._();
  GetDiscoveredServicesRequest createEmptyInstance() => create();
  static $pb.PbList<GetDiscoveredServicesRequest> createRepeated() => $pb.PbList<GetDiscoveredServicesRequest>();
  @$core.pragma('dart2js:noInline')
  static GetDiscoveredServicesRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetDiscoveredServicesRequest>(create);
  static GetDiscoveredServicesRequest? _defaultInstance;
...
class DiscoveredService extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DiscoveredService', createEmptyInstance: create)
    ..aOM<Uuid>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serviceUuid', protoName: 'serviceUuid', subBuilder: Uuid.create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serviceIndex', protoName: 'serviceIndex')
    ..pc<Uuid>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'characteristicUuids', $pb.PbFieldType.PM, protoName: 'characteristicUuids', subBuilder: Uuid.create)
    ..pc<DiscoveredService>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'includedServices', $pb.PbFieldType.PM, protoName: 'includedServices', subBuilder: DiscoveredService.create)
    ..pc<DiscoveredCharacteristic>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'characteristics', $pb.PbFieldType.PM, subBuilder: DiscoveredCharacteristic.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.String get serviceIndex => $_getSZ(1);
  @$pb.TagNumber(2)
  set serviceIndex($core.String v) { $_setString(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasServiceIndex() => $_has(1);
  @$pb.TagNumber(2)
  void clearServiceIndex() => clearField(2);

  @$pb.TagNumber(3)
  $core.List<Uuid> get characteristicUuids => $_getList(2);

  @$pb.TagNumber(4)
  $core.List<DiscoveredService> get includedServices => $_getList(3);

  @$pb.TagNumber(5)
  $core.List<DiscoveredCharacteristic> get characteristics => $_getList(4);
}

class DiscoveredCharacteristic extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DiscoveredCharacteristic', createEmptyInstance: create)
    ..aOM<Uuid>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'characteristicId', protoName: 'characteristicId', subBuilder: Uuid.create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'index')
    ...
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serviceIndex', protoName: 'serviceIndex')
    ..aOB(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isReadable', protoName: 'isReadable')
    ..aOB(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isWritableWithResponse', protoName: 'isWritableWithResponse')
    ..aOB(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isWritableWithoutResponse', protoName: 'isWritableWithoutResponse')
    ..aOB(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isNotifiable', protoName: 'isNotifiable')
    ..aOB(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isIndicatable', protoName: 'isIndicatable')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DiscoveredCharacteristic copyWith(void Function(DiscoveredCharacteristic) updates) => super.copyWith((message) => updates(message as DiscoveredCharacteristic)) as DiscoveredCharacteristic; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(4)
  $core.String get serviceIndex => $_getSZ(3);
  @$pb.TagNumber(4)
  set serviceIndex($core.String v) { $_setString(3, v); }
  @$pb.TagNumber(4)
  $core.bool hasServiceIndex() => $_has(3);
  @$pb.TagNumber(4)
  void clearServiceIndex() => clearField(4);

  @$pb.TagNumber(5)
  $core.bool get isReadable => $_getBF(4);
  @$pb.TagNumber(5)
  set isReadable($core.bool v) { $_setBool(4, v); }
  @$pb.TagNumber(5)
  $core.bool hasIsReadable() => $_has(4);
  @$pb.TagNumber(5)
  void clearIsReadable() => clearField(5);

  @$pb.TagNumber(6)
  $core.bool get isWritableWithResponse => $_getBF(5);
  @$pb.TagNumber(6)
  set isWritableWithResponse($core.bool v) { $_setBool(5, v); }
  @$pb.TagNumber(6)
  $core.bool hasIsWritableWithResponse() => $_has(5);
  @$pb.TagNumber(6)
  void clearIsWritableWithResponse() => clearField(6);

  @$pb.TagNumber(7)
  $core.bool get isWritableWithoutResponse => $_getBF(6);
  @$pb.TagNumber(7)
  set isWritableWithoutResponse($core.bool v) { $_setBool(6, v); }
  @$pb.TagNumber(7)
  $core.bool hasIsWritableWithoutResponse() => $_has(6);
  @$pb.TagNumber(7)
  void clearIsWritableWithoutResponse() => clearField(7);

  @$pb.TagNumber(8)
  $core.bool get isNotifiable => $_getBF(7);
  @$pb.TagNumber(8)
  set isNotifiable($core.bool v) { $_setBool(7, v); }
  @$pb.TagNumber(8)
  $core.bool hasIsNotifiable() => $_has(7);
  @$pb.TagNumber(8)
  void clearIsNotifiable() => clearField(8);

  @$pb.TagNumber(9)
  $core.bool get isIndicatable => $_getBF(8);
  @$pb.TagNumber(9)
  set isIndicatable($core.bool v) { $_setBool(8, v); }
  @$pb.TagNumber(9)
  $core.bool hasIsIndicatable() => $_has(8);
  @$pb.TagNumber(9)
  void clearIsIndicatable() => clearField(9);
}
