...
interface BleClient {
    ...
    fun getDiscoveredServices(deviceId: String): Single<RxBleDeviceServices>
    fun clearGattCache(deviceId: String): Completable
    fun readCharacteristic(deviceId: String, characteristic: UUID, characteristicInstanceId: Int?): Single<CharOperationResult>
    fun setupNotification(deviceId: String, characteristic: UUID, characteristicInstanceId: Int?): Observable<ByteArray>
